pipeline {
    ...
    environment {
        DOCKER_CREDS = 'manisha-dockerhub'
        DOCKER_REG = 'manisha9tech'
        GIT_URL = 'https://github.com/ManishaY9/Learner-Report-Application-Deployment.git'
        GIT_BRANCH = 'main'
        ...
        CLUSTER_NAME = 'manisha-learnerapplication' // EKS cluster name
    }
